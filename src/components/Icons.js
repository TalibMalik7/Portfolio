...
//   #0A66C2
  ...
  export const TwitterX = ({ className, ...rest }) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      xmlSpace="preserve"
      width={256}
    ...
    >
      ...
      >
        <path
          d="m.219 2.882 34.748 46.461L0 87.118h7.87l30.614-33.073 24.735 33.073H90L53.297 38.043 85.844 2.882h-7.87L49.781 33.341 27.001 2.882H.219zm11.574 5.797h12.303L78.425 81.32H66.122L11.793 8.679z"
          style={{
            stroke: "none",
            strokeWidth: 1,
            strokeDasharray: "none",
